...
MyExample::MyExample(TString Name_, TString id_):
  Selection(Name_,id_)
{
}
...
void  MyExample::Configure(){
  ...
  // NVtx=HConfig.GetTH1D(Name+"_NVtx","NVtx",26,-0.5,25.5,"Number of Accumulative Cuts Passed","Events");
    NumVertices=HConfig.GetTH1D(Name+"_NumVertices","NumVertices",26,-0.05,25.5,"Number of Vertex","Events");
...
void  MyExample::Store_ExtraDist(){
   Extradist1d.push_back(&NumVertices);
}

void  MyExample::doEvent(){
  unsigned int t;
  int id(Ntp->GetMCID());
