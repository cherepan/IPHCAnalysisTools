#include "SkimNtupleSingleMuonTrigger.h"
...
SkimNtupleSingleMuonTrigger::SkimNtupleSingleMuonTrigger(TString Name_, TString id_):
  Selection(Name_,id_)
{
}

SkimNtupleSingleMuonTrigger::~SkimNtupleSingleMuonTrigger(){
...
void  SkimNtupleSingleMuonTrigger::Configure(){
  // Setup Cut Values
...
void  SkimNtupleSingleMuonTrigger::Store_ExtraDist(){
...
void  SkimNtupleSingleMuonTrigger::doEvent(){ //  Method called on every event
...
void  SkimNtupleSingleMuonTrigger::Finish(){
